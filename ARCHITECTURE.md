...
│   └── common/             # Sidebar, Navbar, EmptyState, Loading                     → Behruz Shogirt / Ziyoddila
├── layouts/                # AppLayout, AuthLayout                                     → Ziyoddila
├── routes/                 # ProtectedRoute (rolga qarab kirish)                       → Ziyoddila
