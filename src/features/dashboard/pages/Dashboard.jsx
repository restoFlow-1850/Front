...
// RestaurantMapCard moved to the app sidebar (AppLayout.jsx) — only shown on this Admin page
...
export default function Dashboard() {
  ...
  return (
    <div id="dashboard-container">
      ...
      {/* Main Admin Content Grid: Left side (Database & Map) | Right side (Analytics & Recent Orders) */}
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        {/* Left Side: Database & Restaurants Map */}
        ...
        {/* Right Side: Sales & Top Products Charts + Recent Orders */}
          ...
          <div className="grid gap-5 sm:grid-cols-1 xl:grid-cols-2">
            ...
            <Card>
              ...
              {topProductsQuery.isLoading ? (
                ...
                <Suspense fallback={<Skeleton className="h-64 w-full" />}>
                  <Chart options={topProductsChart.options} series={topProductsChart.series} type="bar" height={260} />
                </Suspense>
              )}
            </Card>
          </div>
