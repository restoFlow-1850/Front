...
// TASDIQLANMAGAN TAXMIN: backend Swagger'da tasdiqlanmagan — standart REST
// konvensiyasi asosida yozilgan. Agar backend boshqa endpoint/usul kutsa
// (masalan yumshoq o'chirish uchun status='deleted'), shu yerni to'g'irlash kifoya.
