...
const Input = forwardRef(function Input({ label, error, className = '', ...props }, ref) {
  return (
    <div className="w-full">
      ...
      <input
        ref={ref}
        className={`min-h-11 w-full rounded-xl border border-[#E5E7EB] bg-[#FFFDF9] px-3.5 py-2.5 text-sm font-medium text-[#111827] placeholder:text-gray-400 outline-none transition-all
